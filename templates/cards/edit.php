...
<div class="form-page">
    <div class="form-page-header">
        ...
        <h1 class="form-page-title">Редактировать товар</h1>
        <p class="form-page-sub">Внесите изменения и сохраните.</p>
    </div>

    <div class="form-card">
        <form method="post" method="post" action="/card/<?= $card->getId() ?>/edit" class="form-wrap">
            ...
            <div class="field">
                ...
                <textarea id="description" name="description" rows="3"
                    placeholder="Краткое описание товара…"><?= $card->getDescription() ?></textarea>
            </div>
